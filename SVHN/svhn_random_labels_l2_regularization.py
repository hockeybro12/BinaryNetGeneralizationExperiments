...
import binary_net_random_labels as binary_net
...
save_path_string += "/model_parameters_random_labels_svhn_l2_regularization"
...
if __name__ == "__main__":
    ...
    valid_set.y = np.reshape(valid_set.y, (-1))
    ...
    # 1024FP-1024FP-10FP            
    cnnDense1 = binary_net.DenseLayer(
                cnn, 
                binary=binary,
                stochastic=stochastic,
                H=H,
    ...
    cnnDense2 = binary_net.DenseLayer(
                cnn, 
                binary=binary,
                stochastic=stochastic,
                H=H,
    ...
    cnnDense3 = binary_net.DenseLayer(
                cnn, 
                binary=binary,
                stochastic=stochastic,
                H=H,
    ...
    # l2 regularization
    l2_layers = {cnnDense1: 0.0005, cnnDense2: 0.0005, cnnDense3: 0.0005}
    l2_penalty = regularize_layer_params_weighted(l2_layers, l2) 
